...
function define_boundary_planes()
    ...
    push!(planes, PlaneDefinition(
        ...
        Ellipse(8.0, 18.0),   # ellipse: a=8 (x-semi-axis), b=22.5 (z-semi-axis)
    ))
...
function main()
    ...
    grid_file = "Z_chapadlo_FineGrid_B-2.0085_smooth-1_Interpolation.jld2"
    sdf_file = "Z_chapadlo_FineSDF_B-2.0085_smooth-1_Interpolation.jld2"
    ...
    try
        mesh =
            generate_tetrahedral_mesh(grid_file, sdf_file, output_prefix; options = options)
